...
namespace Geekspace.Data.Migrations
{
    ...
    [Migration("20260725132817_AddQuestionIdToComments")]
    partial class AddQuestionIdToComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Geekspace.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Geekspace.Models.LearningResource", b =>
                {
                    ...
                    b.Property<string>("DownloadableFilePath")
                        .HasMaxLength(300)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Geekspace.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Geekspace.Models.ResourceComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Geekspace.Models.LearningResource", b =>
                {
                    b.HasOne("Geekspace.Models.Category", "Category")
                        .WithMany("Resources")
            ...
            modelBuilder.Entity("Geekspace.Models.Notification", b =>
                {
                    b.HasOne("Geekspace.Models.ResourceComment", "Comment")
                        .WithMany()
            ...
            modelBuilder.Entity("Geekspace.Models.ResourceComment", b =>
                {
                    ...
                    b.HasOne("Geekspace.Models.ResourceComment", "ParentComment")
                        .WithMany()
